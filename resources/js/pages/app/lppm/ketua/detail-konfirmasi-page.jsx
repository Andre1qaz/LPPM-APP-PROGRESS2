...
export default function KetuaDetailKonfirmasiPage({ paper, dokumen }) {
    return (
        <AppLayout pageName="Detail Paper">
            <div className="w-full max-w-5xl mx-auto px-6 py-10 space-y-10">
                ...
                <div className="border rounded-lg bg-white shadow-sm p-6 space-y-4">
                    <h2 className="font-semibold text-lg">Informasi Umum Paper</h2>
                    <hr />
                ...
                <div className="border rounded-lg bg-white shadow-sm p-6">
                    <h2 className="font-semibold text-lg mb-4">Dokumen Wajib</h2>
                    <hr className="mb-4" />
                ...
                <div className="flex justify-between">
                    ...
                    <button
                        onClick={() =>
                            (window.location.href = route("lppm.ketua.pengajuan-dana.upload", paper.id))
                        }
